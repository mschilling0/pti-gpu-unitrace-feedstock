...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pti-gpu-unitrace-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pti-gpu-unitrace-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add intel-pti pti-gpu-unitrace
# for installing globally
pixi global install intel-pti pti-gpu-unitrace
```
...
It is possible to list all of the versions of `intel-pti` available on your platform:
...
```
pixi search intel-pti --channel conda-forge
```
